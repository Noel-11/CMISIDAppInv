Imports System.Data
Partial Class Secured_SystemAdministration_UserPermissionAdd
    ...
    Dim _struserid, _struserroleid As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        _struserid = Request("nuserid")
        _struserroleid = Request("nuserroleid")

        If Not Page.IsPostBack Then
            Dim _clsUser As New clsUser
            _clsUser.getUserInformation(_struserid)
            lblUserId.Text = _clsUser.userID
            lblName.Text = _clsUser.userName
            fillGridView()
        End If
    ...
    Protected Sub btnHome_Click(sender As Object, e As EventArgs)
        Response.Redirect("UserPermission.aspx")
    End Sub
    ...
    Public Sub Update_Permission(ByRef dt As DataTable)
        ...
        dtParent = _clsCMSPermission.fnModuleUserPermissionParent(_struserid)
        ...
        If dtParent.Rows.Count > 0 Then
            ...
            For Each drParent As DataRow In dtParent.Rows
                ...
                dtChild = _clsCMSPermission.fnModuleUserPermissionChild(drParent("menu_id"), _struserid)
