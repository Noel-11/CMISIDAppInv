           ...
           <asp:Panel DefaultButton="btnSearch" runat="server">
                ...
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <asp:GridView runat="server" ID="_gv" HeaderStyle-Font-Size="11px" CssClass="table table-row-bordered table-row-dashed gy-5 table-hover table-striped table-bordered" PageSize="15" EmptyDataText="NO RECORD FOUND"
                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false"
                                GridLines="None" Font-Names="Arial" Font-Size="12px" ForeColor="#000000" AllowPaging="true">
                                <Columns>
                                    <asp:BoundField DataField="abbreviation" HeaderText="Abbreviation" ItemStyle-Width="20%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="division_name" HeaderText="Division Name" ItemStyle-Width="20%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="" HeaderStyle-Width="1%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="lnkEdit" ImageUrl="~/images/edit.png" OnCommand="cmdGVUpdate"
                                                CommandArgument='<%# Bind("division_id")%>' ToolTip="Click to View/Edit Record" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                    <ContentTemplate>
                        <div class="modal-header" style="border-top-left-radius: 10px; border-top-right-radius: 10px; background-color: #3366cc; text-align: center; font-weight: bold; font-size: large; color: black" runat="server" id="div1">
                            <asp:Label runat="server" ID="lbl" Style="font-family: 'Times New Roman'; font-size: x-large; font-weight: bold; color: white" Text="Division Details"></asp:Label>
                        ...
                        <div class="modal-body container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-outline mb-4">
                                        <asp:TextBox runat="server" ID="txtAbbreviation" class="form-control form-control-lg" placeholder="Abbreviation"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-outline mb-4">
                                        <asp:TextBox runat="server" ID="txtDivisionName" class="form-control form-control-lg" placeholder="Division Name"></asp:TextBox>
